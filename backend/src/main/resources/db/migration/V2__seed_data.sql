...
VALUES 
('11111111-1111-1111-1111-111111111111', 'admin@smartlock.com', '$2a$12$W9yG3y/a3z.K3pBthZ4XOuPj/9e3XbY9M.XwXfJ/.Fv1vMhV.6sF6', 'Admin User', 'https://avatar.iran.liara.run/public/1', 'ROLE_ADMIN', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('22222222-2222-2222-2222-222222222222', 'user@smartlock.com', '$2a$12$W9yG3y/a3z.K3pBthZ4XOuPj/9e3XbY9M.XwXfJ/.Fv1vMhV.6sF6', 'John Doe', 'https://avatar.iran.liara.run/public/2', 'ROLE_USER', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
('33333333-3333-3333-3333-333333333333', 'Front Door Lock', 'SL-FRONT-001', 'BLYNK', 'blynk_token_xyz_123', 'Front Door', 21.0285, 105.8542, TRUE, '11111111-1111-1111-1111-111111111111', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
('66666666-6666-6666-6666-666666666666', '33333333-3333-3333-3333-333333333333', '$2a$12$W9yG3y/a3z.K3pBthZ4XOuPj/9e3XbY9M.XwXfJ/.Fv1vMhV.6sF6', 400, 500, 5, TRUE, TRUE, TRUE, 5, 300, 60, CURRENT_TIMESTAMP),
('77777777-7777-7777-7777-777777777777', '33333333-4444-4444-4444-444444444444', NULL, 400, 500, 10, FALSE, TRUE, FALSE, 3, 120, 30, CURRENT_TIMESTAMP);
...
VALUES
('aaaaaaaa-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', NULL, 'APP', 'UNLOCK', 'Unlocked via mobile app', CURRENT_TIMESTAMP),
('bbbbbbbb-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', NULL, '88888888-8888-8888-8888-888888888888', 'FINGERPRINT', 'UNLOCK', 'Unlocked via fingerprint', CURRENT_TIMESTAMP);

-- 8. Seed Alerts
INSERT INTO alerts (id, device_id, alert_type, severity, message, sensor_value, is_resolved, resolved_by, created_at)
VALUES
('cccccccc-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'GAS_LEAK', 'HIGH', 'Abnormal gas levels detected! Value: 850', 850, FALSE, NULL, CURRENT_TIMESTAMP),
('dddddddd-4444-4444-4444-444444444444', '33333333-3333-3333-3333-333333333333', 'INTRUDER', 'CRITICAL', 'Motion detected when locked.', NULL, TRUE, '11111111-1111-1111-1111-111111111111', CURRENT_TIMESTAMP);
...
('ffffffff-6666-6666-6666-666666666666', '33333333-3333-3333-3333-333333333333', 850, 400, TRUE, 27.1, 'Cloudy', CURRENT_TIMESTAMP);
