        ...
        <div style={{ gridColumn: 'span 12' }} className="md-span-6">
           <div className="card" style={{ padding: '2rem', minHeight: '100%' }}>
             ...
             <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
               ...
               <button className="btn btn--secondary w-full" style={{ width: '100%' }}>Manage Networks</button>
             </div>
           </div>
        </div>
        <div style={{ gridColumn: 'span 12' }} className="md-span-6">
           <div className="card" style={{ padding: '2rem', minHeight: '100%' }}>
             ...
             <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
               ...
               <button className="btn btn--primary w-full" style={{ width: '100%' }}>Check for Updates</button>
             </div>
           </div>
        </div>
      </div>
