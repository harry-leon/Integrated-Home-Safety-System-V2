  ...
  return (
    <DashboardLayout tabs={tabs} activeTab="tabRemoteAccess">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '2rem' }}>
        ...
        {/* Toggles and Alerts */}
        <div style={{ gridColumn: 'span 12' }} className="lg-span-5 space-y-4">
          ...
          <div className="card" style={{ marginTop: '1rem', padding: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '2rem', marginTop: '2rem' }}>
        <div style={{ gridColumn: 'span 4' }} className="md-span-4">
          <div className="card" style={{ padding: '2rem' }}>
            ...
            <input type="range" className="range-slider" min="0" max="1000" value={gasThreshold} onChange={(e) => setGasThreshold(e.target.value)} />
        ...
        <div style={{ gridColumn: 'span 4' }} className="md-span-4">
          <div className="card" style={{ padding: '2rem' }}>
            ...
            <input type="range" className="range-slider" min="0" max="100" value={ldrThreshold} onChange={(e) => setLdrThreshold(e.target.value)} />
            <div className="font-label" style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1rem', fontSize: '0.625rem', color: 'var(--on-surface-variant)', textTransform: 'uppercase', letterSpacing: '0.15em' }}>
              <span>{t('dark')}</span>
              <span>{t('bright')}</span>
            </div>
        ...
        <div style={{ gridColumn: 'span 4' }} className="md-span-4">
          <div className="card" style={{ padding: '2rem' }}>
            ...
            <input type="range" className="range-slider" min="5" max="120" value={autoLockDelay} onChange={(e) => setAutoLockDelay(e.target.value)} />
            <div className="font-label" style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1rem', fontSize: '0.625rem', color: 'var(--on-surface-variant)', textTransform: 'uppercase', letterSpacing: '0.15em' }}>
              <span>{t('minText')}</span>
              <span>{t('maxText')}</span>
            </div>
